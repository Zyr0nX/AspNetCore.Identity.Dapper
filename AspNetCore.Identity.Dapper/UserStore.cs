...
public class UserStore : UserStore<IdentityUser>
{
    ...
    public UserStore(IdentityErrorDescriber? describer, IUsersProvider<IdentityUser, string> usersProvider,
        IRolesProvider<IdentityRole, IdentityUser, string> rolesProvider, IUserRolesProvider<IdentityUserRole<string>, IdentityUser, string> userRolesProvider,
        IUserLoginsProvider<IdentityUserLogin<string>, IdentityUser, string> userLoginsProvider,
        IUserClaimsProvider<IdentityUserClaim<string>, IdentityUser, string> userClaimsProvider,
        IUserTokensProvider<IdentityUserToken<string>, IdentityUser, string> userTokensProvider) : base(describer, usersProvider, rolesProvider, userRolesProvider, userLoginsProvider, userClaimsProvider, userTokensProvider)
    {
    }
}
    ...
    where TUser : IdentityUser, new()
{
    ...
    public UserStore(IdentityErrorDescriber? describer, IUsersProvider<TUser, string> usersProvider,
        IRolesProvider<IdentityRole, TUser, string> rolesProvider, IUserRolesProvider<IdentityUserRole<string>, TUser, string> userRolesProvider,
        IUserLoginsProvider<IdentityUserLogin<string>, TUser, string> userLoginsProvider,
        IUserClaimsProvider<IdentityUserClaim<string>, TUser, string> userClaimsProvider,
        IUserTokensProvider<IdentityUserToken<string>, TUser, string> userTokensProvider) : base(describer, usersProvider, rolesProvider, userRolesProvider, userLoginsProvider, userClaimsProvider, userTokensProvider)
    {
    }
}
    ...
    where TRole : IdentityRole
{
    ...
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    public UserStore(IdentityErrorDescriber? describer, IUsersProvider<TUser, string> usersProvider,
        IRolesProvider<TRole, TUser, string> rolesProvider, IUserRolesProvider<IdentityUserRole<string>, TUser, string> userRolesProvider,
        IUserLoginsProvider<IdentityUserLogin<string>, TUser, string> userLoginsProvider,
        IUserClaimsProvider<IdentityUserClaim<string>, TUser, string> userClaimsProvider,
        IUserTokensProvider<IdentityUserToken<string>, TUser, string> userTokensProvider) : base(describer, usersProvider, rolesProvider, userRolesProvider, userLoginsProvider, userClaimsProvider, userTokensProvider)
    {
    ...
    where TKey : IEquatable<TKey>
{
    ...
    /// <param name="context">The <see cref="DbContext"/>.</param>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    public UserStore(IdentityErrorDescriber describer, IUsersProvider<TUser, TKey> usersProvider,
        IRolesProvider<TRole, TUser, TKey> rolesProvider, IUserRolesProvider<IdentityUserRole<TKey>, TUser, TKey> userRolesProvider, IUserLoginsProvider<IdentityUserLogin<TKey>, TUser, TKey> userLoginsProvider,
        IUserClaimsProvider<IdentityUserClaim<TKey>, TUser, TKey> userClaimsProvider,
        IUserTokensProvider<IdentityUserToken<TKey>, TUser, TKey> userTokensProvider) : base(describer, usersProvider, rolesProvider, userRolesProvider, userLoginsProvider, userClaimsProvider, userTokensProvider)
    {
    }
}
    ...
    where TRoleClaim : IdentityRoleClaim<TKey>, new()
{
    ...
    protected UserStore(IdentityErrorDescriber? describer, IUsersProvider<TUser, TKey> usersProvider,
        IRolesProvider<TRole, TUser, TKey> rolesProvider, IUserRolesProvider<TUserRole, TUser, TKey> userRolesProvider,
        IUserLoginsProvider<TUserLogin, TUser, TKey> userLoginsProvider,
        IUserClaimsProvider<TUserClaim, TUser, TKey> userClaimsProvider,
        IUserTokensProvider<TUserToken, TUser, TKey> userTokensProvider) : base(describer ??
    ...
    private readonly IRolesProvider<TRole, TUser, TKey> _rolesProvider;
    private readonly IUserRolesProvider<TUserRole, TUser, TKey> _userRolesProvider;
    private readonly IUserLoginsProvider<TUserLogin, TUser, TKey> _userLoginsProvider;
    private readonly IUserClaimsProvider<TUserClaim, TUser, TKey> _userClaimsProvider;
    private readonly IUserTokensProvider<TUserToken, TUser, TKey> _userTokensProvider;
        ...
        CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        await _usersProvider.CreateAsync(user);
        ...
        CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        try
        {
            await _usersProvider.UpdateAsync(user);
        }
        ...
        CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        try
        {
            await _usersProvider.DeleteAsync(user);
        }
        catch (DBConcurrencyException)
        {
            return IdentityResult.Failed(ErrorDescriber.ConcurrencyFailure());
    ...
    {
        return await _usersProvider.FindUserAsync(userId);
    }
    ...
    protected override async Task<TUserLogin?> FindUserLoginAsync(TKey userId, string loginProvider, string providerKey,
        CancellationToken cancellationToken)
    {
        return await _userLoginsProvider.FindUserLoginAsync(userId, loginProvider, providerKey);
    }
    ...
    protected override Task<TUserLogin?> FindUserLoginAsync(string loginProvider, string providerKey,
        CancellationToken cancellationToken)
    {
        return _userLoginsProvider.FindUserLoginAsync(loginProvider, providerKey);
    }
        ...
        CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        if (roleEntity != null)
        {
            ...
            if (userRole != null)
            {
                await _userRolesProvider.RemoveUserRoleAsync(userRole);
            }
        }
    }
        ...
        CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        return await _userClaimsProvider.GetClaimsAsync(user);
    }
        ...
        CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        await _userClaimsProvider.AddClaimsAsync(userClaims);
    }
        ...
        CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        await _userClaimsProvider.ReplaceClaimAsync(user, claim, newClaim);
    }
        ...
        CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        await _userClaimsProvider.RemoveClaimsAsync(user, claims);
    }
        ...
        CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        await _userLoginsProvider.AddLoginAsync(user, login);
    }
        ...
        CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        ArgumentNullException.ThrowIfNull(user);
        var userId = user.Id;
        return await _userLoginsProvider.GetLoginsAsync(userId);
    }
        ...
        CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        return await _usersProvider.FindByEmailAsync(normalizedEmail);
    }
        ...
        CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        if (role != null)
        {
            return await _rolesProvider.GetUsersInRoleAsync(role);
        }
    ...
    protected override Task<TUserToken?> FindTokenAsync(TUser user, string loginProvider, string name,
        CancellationToken cancellationToken)
        => _userTokensProvider.FindTokenAsync(user, loginProvider, name);
    ...
    {
        await _userTokensProvider.AddUserTokenAsync(token);
    }
    ...
    {
        await _userTokensProvider.RemoveUserTokenAsync(token);
    }
